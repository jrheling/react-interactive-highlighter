...
// from https://github.com/elboman/typescript-lib-example/blob/master/webpack.config.js
//  as referenced in https://marcobotto.com/blog/compiling-and-bundling-typescript-libraries-with-webpack/
...
//   entryPoint: path.resolve(__dirname, 'src/index.ts'),
  entryPoint: path.resolve(__dirname, 'src/InteractiveHighlighter.tsx'),
...
var config = {
  ...
  output: {
    ...
    filename: '[name].js',
    libraryTarget: 'umd',
    library: 'react-interactive-highlighter',
    umdNamedDefine: true
  },
